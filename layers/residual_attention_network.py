...
from layers.attention_module import AttentionModule_stage1, AttentionModule_stage2, AttentionModule_stage3, AttentionModule_stage0
from layers.attention_module import AttentionModule_stage1_cifar, AttentionModule_stage2_cifar, AttentionModule_stage3_cifar


class ResidualAttentionModel_448input(pl.LightningModule):
    # for input size 448
    def __init__(self):
...
class ResidualAttentionModel_92(pl.LightningModule):
    # for input size 224
    def __init__(self):
...
class ResidualAttentionModel_92_32input_update(pl.LightningModule):
    # for input size 32
    def __init__(self):
