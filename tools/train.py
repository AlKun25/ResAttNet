...
from .model.residual_attention_network import ResidualAttentionModel_56, ResidualAttentionModel_92_32input_update as ResidualAttentionModel
...
def train(is_train, is_pretrain, lr, total_epoch, acc_best, criterion, optimizer):
    if is_train is True:
        if is_pretrain == True:
...
if __name__ == "__main__":
    ...
    acc_best = 0
    total_epoch = 10
    train(is_train, is_pretrain, lr, total_epoch, acc_best, criterion, optimizer)