...
## Repositories we have referred to for implementing this paper
...
|---|---|---|---|---|---|
| CIFAR-100 | Residual Attention Network  | SGD | - | - | PyTorch-Lightning|
| CIFAR-10 | Residual Attention Network  | SGD | - | - | PyTorch-Lightning|
