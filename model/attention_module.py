...
class AttentionModule_stage0(pl.LightningModule):
...
class AttentionModule_stage1(pl.LightningModule):
    # input size is 56*56
...
class AttentionModule_stage2(pl.LightningModule):
...
class AttentionModule_stage3(pl.LightningModule):
...
class AttentionModule_stage1_cifar(pl.LightningModule):
    # input size is 16*16
...
class AttentionModule_stage2_cifar(pl.LightningModule):
    # input size is 8*8
...
class AttentionModule_stage3_cifar(pl.LightningModule):
    # input size is 4*4
    def __init__(self, in_channels, out_channels, size=(8, 8)):
